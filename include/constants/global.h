...
#define OPTIONS_MOVEMENT_MODE_WALK 0
#define OPTIONS_MOVEMENT_MODE_RUN  1

#define OPTIONS_CLOCK_FORMAT_OFF  0
#define OPTIONS_CLOCK_FORMAT_12HR 1
#define OPTIONS_CLOCK_FORMAT_24HR 2
...
#define OPTIONS_BATTLE_ITEMS_EVERYBODY   0
#define OPTIONS_BATTLE_ITEMS_PLAYER_ONLY 1
#define OPTIONS_BATTLE_ITEMS_FOE_ONLY    2
#define OPTIONS_BATTLE_ITEMS_NOBODY      3

#define OPTIONS_ENEMY_AI_NORMAL 0
#define OPTIONS_ENEMY_AI_SMART  1
