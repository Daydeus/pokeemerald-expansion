...
static const u8 sBerryDescriptionPart1_Watmel[] = _("A huge Berry, with some as large");
static const u8 sBerryDescriptionPart2_Watmel[] = _("as a head found. Exceedingly sweet.");
